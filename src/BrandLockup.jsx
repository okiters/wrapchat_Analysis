...
export default function BrandLockup({
  ...
  return (
    <div style={{ width: "100%", display: "flex", flexDirection: "column", alignItems: "center" }}>
      ...
      >
        {useInline ? (
          <div style={{ marginBottom: inline ? 0 : 14, flexShrink: 0 }}>
            <LogoSVG size={logoSize} accentColor={accentColor} />
          </div>
        ) : (
          <img
            src={logoSrc}
