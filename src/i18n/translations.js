...
export const UI_TRANSLATIONS = {
  en: {
    ...
    "quips.duo.responseBalanced": [
      `"Nobody left on read. Not once."`,
      `"You both answer like the phone was already in your hand."`,
      `"Neither of you has ever had to check if the message delivered."`,
    ],
    "quips.duo.ghost": [
      `"{name} was 'busy'. Sure."`,
    ...
    "quips.duo.streak100": [
      ...
      `"{streak} days in a row. Somebody would have noticed if you stopped."`,
      `"{streak} days without missing. Even your worst days made the list."`,
    ],
    "quips.duo.streak30": [
      `"{streak} days straight. Neither of you once got too busy."`,
      `"A month of nobody dropping the thread. Was that on purpose?"`,
      `"{streak} days. Long enough that going quiet would have felt weird."`,
    ],
    "quips.duo.streak10": [
      `"{streak} days in a row, and then life happened."`,
      `"Okay, that's actually kind of cute."`,
      `"{streak} days where checking your phone was actually worth it."`,
    ],
    "quips.duo.streakShort": [
      `"{streak} days. Then somebody fell asleep first."`,
      `"Your record is {streak} days. Bar set low, bar cleared."`,
      `"{streak} days in a row. You have both been busy, clearly."`,
    ],
    "quips.duo.convStarter": [
      `"{name} never once waited to see who would cave first."`,
      `"{name} is always the one who breaks the silence first."`,
      `"Every silence ends the same way: {name} types."`,
    ],
    "quips.duo.messageLengthSimilar": [
      `"Almost identical message lengths. Suspiciously balanced."`,
      `"You have both landed on exactly the same number of words. Creepy."`,
      `"Neither of you writes more than the other. Matched without noticing."`,
    ],
    ...
    "quips.group.streak30": [
      `"{streak} days and not one of you let it die."`,
      `"A month straight. Somebody always had something to say."`,
      `"Most group chats go quiet after two weeks. This one didn't."`,
    ],
    "quips.group.streak10": [
      `"{streak} days where nobody had to revive the chat."`,
      `"You all actually like each other. Surprising."`,
      `"{streak} days in a row, then everyone remembered they had jobs."`,
    ],
    "quips.group.streakShort": [
      `"{streak} days. Then the group went back to lurking."`,
      `"Your best run is {streak} days. Everyone is busy, apparently."`,
      `"{streak} days in a row before the silence won."`,
    ],
  ...
  tr: {
    ...
    "The energy read": "Enerji okuması",
    ...
    "quips.duo.responseBalanced": [
      `"Kimse kimseyi görüldüde bırakmamış. Bir kere bile."`,
      `"İkiniz de telefon zaten elinizdeymiş gibi cevap veriyorsunuz."`,
      `"Hiçbiriniz mesaj gitti mi diye kontrol etmek zorunda kalmamış."`,
    ],
    "quips.duo.ghost": [
    ...
    "quips.duo.streak100": [
      ...
      `"{streak} gün üst üste. Bıraksanız biri mutlaka fark ederdi."`,
      `"{streak} gün hiç atlamadan. En kötü gününüz bile listeye girmiş."`,
    ],
    "quips.duo.streak30": [
      `"{streak} gün aralıksız. İkinizin de işi hiç başından aşmamış."`,
      `"Bir ay boyunca kimse konuyu düşürmemiş. Bilerek mi acaba?"`,
      `"{streak} gün. Susmanın tuhaf kaçacağı kadar uzun."`,
    ],
    "quips.duo.streak10": [
      `"{streak} gün üst üste, sonra hayat araya girdi."`,
      `"Tamam, bu aslında biraz tatlı."`,
      `"{streak} gün boyunca telefona bakmak gerçekten değdi."`,
    ],
    "quips.duo.streakShort": [
      `"{streak} gün. Sonra biriniz önce uyuyakaldı."`,
      `"Rekorunuz {streak} gün. Çıta düşük, çıta geçildi."`,
      `"{streak} gün üst üste. İkiniz de meşgulsünüz belli."`,
    ],
    "quips.duo.convStarter": [
      `"{name} bir kere bile kim önce dayanacak diye beklememiş."`,
      `"{name} sessizliği ilk bozan kişi olmaya devam ediyor."`,
      `"Her sessizlik aynı şekilde bitiyor: {name} yazıyor."`,
    ],
    "quips.duo.messageLengthSimilar": [
      `"Mesaj uzunlukları neredeyse aynı. Şüpheli derecede dengeli."`,
      `"İkiniz de tam olarak aynı sayıda kelimede karar kılmışsınız. Ürkütücü."`,
      `"Hiçbiriniz diğerinden uzun yazmıyor. Farkında olmadan eşleşmişsiniz."`,
    ],
    "quips.duo.messageLengthDifferent": [
    ...
    "quips.group.streak30": [
      `"{streak} gün ve içinizden biri bile sohbeti düşürmemiş."`,
      `"Bir ay aralıksız. Her gün birinin söyleyecek bir şeyi olmuş."`,
      `"Çoğu grup iki haftada susar. Bu grup susmadı."`,
    ],
    "quips.group.streak10": [
      `"{streak} gün boyunca kimse grubu diriltmek zorunda kalmamış."`,
      `"Demek ki hepiniz birbirinizi gerçekten seviyorsunuz. Şaşırtıcı."`,
      `"{streak} gün üst üste, sonra herkes işi olduğunu hatırladı."`,
    ],
    "quips.group.streakShort": [
      `"{streak} gün. Sonra grup yine lurk moduna geçti."`,
      `"En iyi seriniz {streak} gün. Herkes meşgul anlaşılan."`,
      `"{streak} gün üst üste, sonra sessizlik kazandı."`,
    ],
    "quips.group.novelist": [
    ...
    "Powered by AI — analysed securely, never stored.": "Yapay zekâ destekli — güvenle analiz edilir, asla saklanmaz.",
  ...
  es: {
    ...
    "quips.duo.responseBalanced": [`"Nadie ha dejado a nadie en visto. Ni una vez."`,`"Los dos contestáis como si ya tuvierais el móvil en la mano."`,`"Ninguno ha tenido que mirar si el mensaje llegó."`],
    ...
    "quips.duo.streak100": [`"{streak} días. Eso no es una racha, es un estilo de vida."`,`"{streak} días seguidos. Si hubierais parado, alguien lo habría notado."`,`"{streak} días sin fallar. Hasta vuestros peores días entraron en la lista."`],
    "quips.duo.streak30": [`"{streak} días seguidos. A ninguno se le complicó la vida ni una vez."`,`"Un mes sin que nadie dejara caer la conversación. ¿A propósito?"`,`"{streak} días. Tantos que callarse habría sido raro."`],
    "quips.duo.streak10": [`"{streak} días seguidos, y entonces apareció la vida."`,`"Vale, eso sí es un poco tierno."`,`"{streak} días en los que mirar el móvil valía la pena."`],
    "quips.duo.streakShort": [`"{streak} días. Luego alguien se durmió primero."`,`"Vuestro récord son {streak} días. Listón bajo, listón superado."`,`"{streak} días seguidos. Los dos andáis ocupados, está claro."`],
    "quips.duo.convStarter": [`"{name} no esperó ni una vez a ver quién cedía primero."`,`"{name} siempre rompe el silencio primero."`,`"Cada silencio termina igual: escribe {name}."`],
    "quips.duo.messageLengthSimilar": [`"Mensajes casi idénticos. Sospechosamente equilibrado."`,`"Los dos habéis acabado en exactamente las mismas palabras. Inquietante."`,`"Ninguno escribe más que el otro. Os habéis sincronizado sin daros cuenta."`],
    ...
    "quips.group.streak30": [`"{streak} días y ninguno de vosotros dejó que muriera."`,`"Un mes seguido. Siempre había alguien con algo que decir."`,`"La mayoría de los grupos mueren en dos semanas. Este no."`],
    "quips.group.streak10": [`"{streak} días en los que nadie tuvo que resucitar el chat."`,`"Parece que sí se caen bien. Sorpresa."`,`"{streak} días seguidos, y luego todos recordaron que trabajan."`],
    "quips.group.streakShort": [`"{streak} días. Luego el grupo volvió a mirar en silencio."`,`"Vuestra mejor racha son {streak} días. Todos ocupados, por lo visto."`,`"{streak} días seguidos antes de que ganara el silencio."`],
    ...
    "Powered by AI — analysed securely, never stored.": "Impulsado por IA — analizado de forma segura, nunca almacenado.",
    ...
    "The energy read": "La lectura de energía",
  ...
  pt: {
    ...
    "quips.duo.responseBalanced": [`"Ninguém deixou ninguém no vácuo. Nem uma vez."`,`"Vocês dois respondem como se o celular já estivesse na mão."`,`"Nenhum dos dois precisou conferir se a mensagem chegou."`],
    ...
    "quips.duo.streak100": [`"{streak} dias. Isso não é sequência, é estilo de vida."`,`"{streak} dias seguidos. Se parassem, alguém ia perceber."`,`"{streak} dias sem falhar. Até os piores dias entraram na lista."`],
    "quips.duo.streak30": [`"{streak} dias seguidos. Nenhum dos dois ficou ocupado nem uma vez."`,`"Um mês sem ninguém deixar a conversa cair. Foi de propósito?"`,`"{streak} dias. Tempo suficiente pra que o silêncio ficasse estranho."`],
    "quips.duo.streak10": [`"{streak} dias seguidos, e então a vida apareceu."`,`"Ok, isso é bem fofo."`,`"{streak} dias em que olhar o celular valeu a pena."`],
    "quips.duo.streakShort": [`"{streak} dias. Aí alguém dormiu primeiro."`,`"O recorde de vocês é {streak} dias. Régua baixa, régua batida."`,`"{streak} dias seguidos. Vocês dois andam ocupados, dá pra ver."`],
    "quips.duo.convStarter": [`"{name} nunca esperou pra ver quem cedia primeiro."`,`"{name} é sempre quem quebra o silêncio."`,`"Todo silêncio termina do mesmo jeito: {name} escreve."`],
    "quips.duo.messageLengthSimilar": [`"Mensagens quase iguais. Equilíbrio suspeito."`,`"Vocês dois pararam exatamente no mesmo número de palavras. Assustador."`,`"Nenhum escreve mais que o outro. Se sincronizaram sem perceber."`],
    ...
    "quips.group.streak30": [`"{streak} dias e nenhum de vocês deixou morrer."`,`"Um mês seguido. Sempre tinha alguém com algo pra dizer."`,`"A maioria dos grupos morre em duas semanas. Esse não."`],
    "quips.group.streak10": [`"{streak} dias em que ninguém precisou ressuscitar o grupo."`,`"Vocês realmente gostam uns dos outros. Surpreendente."`,`"{streak} dias seguidos, aí todo mundo lembrou que tem trabalho."`],
    "quips.group.streakShort": [`"{streak} dias. Aí o grupo voltou a só observar."`,`"A melhor sequência de vocês é {streak} dias. Todo mundo ocupado, pelo visto."`,`"{streak} dias seguidos antes de o silêncio vencer."`],
    ...
    "Powered by AI — analysed securely, never stored.": "Alimentado por IA — analisado com segurança, nunca armazenado.",
    ...
    "The energy read": "A leitura de energia",
  ...
  ar: {
    ...
    "quips.duo.responseBalanced": [`"لا أحد ترك الآخر على علامة القراءة. ولا مرة واحدة."`,`"كلاكما يرد وكأن الهاتف في يده أصلاً."`,`"لم يضطر أي منكما للتأكد إن وصلت الرسالة."`],
    ...
    "quips.duo.streak100": [`"{streak} يومًا. هذه ليست سلسلة بل أسلوب حياة."`,`"{streak} يوماً متتالياً. لو توقفتما لانتبه أحدهم."`,`"{streak} يوماً دون انقطاع. حتى أسوأ أيامكما دخلت القائمة."`],
    "quips.duo.streak30": [`"{streak} يوماً متتالياً. ولا مرة انشغل أحدكما."`,`"شهر كامل ولم يترك أحد الحديث يسقط. عن قصد؟"`,`"{streak} يوماً. مدة تكفي ليصبح الصمت غريباً."`],
    "quips.duo.streak10": [`"{streak} أيام متتالية، ثم تدخلت الحياة."`,`"حسنًا، هذا لطيف فعلًا."`,`"{streak} أيام كان النظر إلى الهاتف يستحق فيها."`],
    "quips.duo.streakShort": [`"{streak} أيام. ثم نام أحدكما أولاً."`,`"رقمكما القياسي {streak} أيام. سقف منخفض، وتم تجاوزه."`,`"{streak} أيام متتالية. كلاكما مشغول، واضح."`],
    "quips.duo.convStarter": [`"{name} لم ينتظر ولا مرة ليرى من سيستسلم أولاً."`,`"{name} هو دائمًا من يكسر الصمت أولًا."`,`"كل صمت ينتهي بالطريقة ذاتها: {name} يكتب."`],
    "quips.duo.messageLengthSimilar": [`"طول الرسائل متقارب جدًا. توازن مريب."`,`"انتهى بكما الأمر إلى العدد نفسه من الكلمات تماماً. مقلق."`,`"لا أحد يكتب أكثر من الآخر. تطابقتما دون أن تنتبها."`],
    ...
    "quips.group.streak30": [`"{streak} يوماً ولم يترك أحدكم المحادثة تموت."`,`"شهر متواصل. دائماً كان لدى أحدهم ما يقوله."`,`"معظم المجموعات تموت خلال أسبوعين. هذه لا."`],
    "quips.group.streak10": [`"{streak} أيام لم يضطر فيها أحد لإنعاش المحادثة."`,`"يبدو أنكم فعلًا تحبون بعضكم. مفاجأة."`,`"{streak} أيام متتالية، ثم تذكر الجميع أن لديهم أعمالاً."`],
    "quips.group.streakShort": [`"{streak} أيام. ثم عادت المجموعة إلى المتابعة بصمت."`,`"أفضل سلسلة لكم {streak} أيام. الجميع مشغول، على ما يبدو."`,`"{streak} أيام متتالية قبل أن ينتصر الصمت."`],
    ...
    "Powered by AI — analysed securely, never stored.": "مدعوم بالذكاء الاصطناعي — يتم التحليل بأمان ولا يتم التخزين أبدًا.",
  ...
  fr: {
    ...
    "quips.duo.responseBalanced": [`"Personne n'a jamais laissé l'autre en vu. Pas une fois."`,`"Vous répondez tous les deux comme si le téléphone était déjà en main."`,`"Aucun des deux n'a eu à vérifier si le message était passé."`],
    ...
    "quips.duo.streak100": [`"{streak} jours. Ce n'est plus une série, c'est un mode de vie."`,`"{streak} jours d'affilée. Si vous vous étiez arrêtés, quelqu'un l'aurait remarqué."`,`"{streak} jours sans en rater un. Même vos pires journées sont dans la liste."`],
    "quips.duo.streak30": [`"{streak} jours d'affilée. Aucun des deux n'a jamais été trop occupé."`,`"Un mois sans que personne ne laisse tomber la conversation. C'était voulu ?"`,`"{streak} jours. Assez pour que le silence paraisse bizarre."`],
    "quips.duo.streak10": [`"{streak} jours d'affilée, et puis la vie s'en est mêlée."`,`"Bon, c'est franchement mignon."`,`"{streak} jours où regarder son téléphone en valait la peine."`],
    "quips.duo.streakShort": [`"{streak} jours. Puis quelqu'un s'est endormi le premier."`,`"Votre record : {streak} jours. Barre basse, barre franchie."`,`"{streak} jours d'affilée. Vous êtes occupés tous les deux, visiblement."`],
    "quips.duo.convStarter": [`"{name} n'a jamais attendu de voir qui craquerait en premier."`,`"{name} est toujours celui qui brise le silence en premier."`,`"Chaque silence se termine pareil : {name} écrit."`],
    "quips.duo.messageLengthSimilar": [`"Longueur des messages presque identique. Suspectement équilibré."`,`"Vous êtes tombés sur exactement le même nombre de mots. Troublant."`,`"Aucun n'écrit plus que l'autre. Vous vous êtes synchronisés sans le vouloir."`],
    ...
    "quips.group.streak30": [`"{streak} jours et aucun de vous ne l'a laissée mourir."`,`"Un mois d'affilée. Il y avait toujours quelqu'un avec quelque chose à dire."`,`"La plupart des groupes meurent en deux semaines. Pas celui-ci."`],
    "quips.group.streak10": [`"{streak} jours où personne n'a eu à ranimer la conversation."`,`"Vous vous aimez vraiment bien. Surprise."`,`"{streak} jours d'affilée, puis tout le monde s'est rappelé qu'il travaillait."`],
    "quips.group.streakShort": [`"{streak} jours. Puis le groupe est retourné lire en silence."`,`"Votre meilleure série : {streak} jours. Tout le monde est occupé, apparemment."`,`"{streak} jours d'affilée avant que le silence ne gagne."`],
    ...
    "Powered by AI — analysed securely, never stored.": "Alimenté par l'IA — analysé en toute sécurité, jamais stocké.",
    ...
    "The energy read": "La lecture d'énergie",
  ...
  de: {
    ...
    "quips.duo.responseBalanced": [`"Keiner hat den anderen je auf Gelesen sitzen lassen. Kein einziges Mal."`,`"Ihr antwortet beide, als läge das Handy schon in der Hand."`,`"Keiner von euch musste je nachsehen, ob die Nachricht ankam."`],
    ...
    "quips.duo.streak100": [`"{streak} Tage. Das ist kein Streak mehr, das ist ein Lebensstil."`,`"{streak} Tage am Stück. Hättet ihr aufgehört, wäre es jemandem aufgefallen."`,`"{streak} Tage ohne Lücke. Selbst eure schlimmsten Tage sind dabei."`],
    "quips.duo.streak30": [`"{streak} Tage am Stück. Keiner von euch hatte je zu viel zu tun."`,`"Einen Monat lang hat keiner das Gespräch fallen lassen. Absicht?"`,`"{streak} Tage. Lang genug, dass Schweigen komisch gewesen wäre."`],
    "quips.duo.streak10": [`"{streak} Tage am Stück, und dann kam das Leben dazwischen."`,`"Okay, das ist tatsächlich ziemlich süß."`,`"{streak} Tage, an denen sich der Blick aufs Handy gelohnt hat."`],
    "quips.duo.streakShort": [`"{streak} Tage. Dann ist einer zuerst eingeschlafen."`,`"Euer Rekord: {streak} Tage. Latte tief gelegt und locker übersprungen."`,`"{streak} Tage am Stück. Ihr habt beide zu tun, offensichtlich."`],
    "quips.duo.convStarter": [`"{name} hat nie abgewartet, wer zuerst nachgibt."`,`"{name} ist immer die Person, die zuerst die Stille bricht."`,`"Jede Stille endet gleich: {name} schreibt."`],
    "quips.duo.messageLengthSimilar": [`"Fast identische Nachrichtenlängen. Verdächtig ausgeglichen."`,`"Ihr seid bei exakt der gleichen Wortzahl gelandet. Unheimlich."`,`"Keiner schreibt mehr als der andere. Ihr habt euch unbemerkt angeglichen."`],
    ...
    "quips.group.streak30": [`"{streak} Tage und keiner von euch hat ihn sterben lassen."`,`"Einen Monat am Stück. Immer hatte jemand etwas zu sagen."`,`"Die meisten Gruppen sterben nach zwei Wochen. Diese nicht."`],
    "quips.group.streak10": [`"{streak} Tage, an denen niemand den Chat wiederbeleben musste."`,`"Ihr mögt euch offenbar wirklich. Überraschend."`,`"{streak} Tage am Stück, dann fiel allen wieder ein, dass sie Jobs haben."`],
    "quips.group.streakShort": [`"{streak} Tage. Dann ist die Gruppe wieder ins Mitlesen zurückgefallen."`,`"Eure beste Serie: {streak} Tage. Alle beschäftigt, offenbar."`,`"{streak} Tage am Stück, bevor die Stille gewonnen hat."`],
    ...
    "Powered by AI — analysed securely, never stored.": "KI-gestützt — sicher analysiert, niemals gespeichert.",
    ...
    "The energy read": "Der Energie-Read",
  ...
  it: {
    ...
    "quips.duo.responseBalanced": [`"Nessuno ha mai lasciato l'altro in visualizzato. Nemmeno una volta."`,`"Rispondete entrambi come se aveste già il telefono in mano."`,`"Nessuno dei due ha mai dovuto controllare se il messaggio fosse arrivato."`],
    ...
    "quips.duo.streak100": [`"{streak} giorni. Non è una streak, è uno stile di vita."`,`"{streak} giorni di fila. Se aveste smesso, qualcuno se ne sarebbe accorto."`,`"{streak} giorni senza saltarne uno. Anche i giorni peggiori sono nella lista."`],
    "quips.duo.streak30": [`"{streak} giorni di fila. Nessuno dei due è mai stato troppo occupato."`,`"Un mese senza che nessuno lasciasse cadere il discorso. Di proposito?"`,`"{streak} giorni. Abbastanza perché il silenzio sarebbe sembrato strano."`],
    "quips.duo.streak10": [`"{streak} giorni di fila, poi è arrivata la vita."`,`"Ok, questo è davvero carino."`,`"{streak} giorni in cui guardare il telefono ne valeva la pena."`],
    "quips.duo.streakShort": [`"{streak} giorni. Poi qualcuno si è addormentato per primo."`,`"Il vostro record è {streak} giorni. Asticella bassa, asticella superata."`,`"{streak} giorni di fila. Siete occupati entrambi, si vede."`],
    "quips.duo.convStarter": [`"{name} non ha mai aspettato per vedere chi cedeva per primo."`,`"{name} è sempre quello che rompe il silenzio per primo."`,`"Ogni silenzio finisce allo stesso modo: scrive {name}."`],
    "quips.duo.messageLengthSimilar": [`"Lunghezze quasi identiche. Sospettosamente equilibrato."`,`"Siete finiti esattamente sullo stesso numero di parole. Inquietante."`,`"Nessuno scrive più dell'altro. Vi siete sincronizzati senza accorgervene."`],
    ...
    "quips.group.streak30": [`"{streak} giorni e nessuno di voi l'ha lasciata morire."`,`"Un mese di fila. C'era sempre qualcuno con qualcosa da dire."`,`"La maggior parte dei gruppi muore dopo due settimane. Questo no."`],
    "quips.group.streak10": [`"{streak} giorni in cui nessuno ha dovuto rianimare la chat."`,`"Vi piacete davvero. Sorprendente."`,`"{streak} giorni di fila, poi tutti si sono ricordati di avere un lavoro."`],
    "quips.group.streakShort": [`"{streak} giorni. Poi il gruppo è tornato a leggere in silenzio."`,`"La vostra serie migliore è {streak} giorni. Tutti occupati, a quanto pare."`,`"{streak} giorni di fila prima che vincesse il silenzio."`],
    ...
    "Powered by AI — analysed securely, never stored.": "Alimentato dall'IA — analizzato in modo sicuro, mai archiviato.",
    ...
    "The energy read": "La lettura dell'energia",
